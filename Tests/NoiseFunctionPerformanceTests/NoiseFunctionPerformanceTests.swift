...
final class NoiseFunctionPerformanceTests: XCTestCase {
    ...
    func testExample() throws {
        ...
        // results.
        let a1: UInt32 = MurmurPRNG_x86_32(seed: 123_456_678).lookup()
        XCTAssertNotNil(a1)
        let a2: [UInt32] = MurmurPRNG_x86_128(seed: 123_456_678).lookup()
        XCTAssertNotNil(a2)
        XCTAssertEqual(a2.count, 4)
        let a3: [UInt64] = MurmurPRNG_x64_128(seed: 123_456_678).lookup()
        XCTAssertNotNil(a3)
    ...
    func testPerf1() throws {
        let q = MurmurPRNG_x86_32(seed: 123_456_678)
        measure {
    ...
    func testPerf2() throws {
        let q = MurmurPRNG_x86_128(seed: 123_456_678)
        measure {
            for _ in 0 ... iterationCount {
                _ = q.lookup()
            }
    ...
    func testPerf3() throws {
        let q = MurmurPRNG_x64_128(seed: 123_456_678)
        measure {
            for _ in 0 ... iterationCount {
                _ = q.lookup()
            }
    ...
    func testPerf4() throws {
        let q = HasherPRNG(seed: 123_456_678)
        measure {
            for _ in 0 ... iterationCount {
                _ = q.lookup()
            }
